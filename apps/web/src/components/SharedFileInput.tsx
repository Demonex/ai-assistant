            ...
            !currentImage ? (
                ...
                <div className='relative '>
                  <img src={currentImage || modifyIcon} alt=""
                       className="w-[7.5rem] min-h-[7.5rem] rounded-[2rem]"/>
                  <div
                    className='w-full min-h-full flex flex-col gap-2 items-center absolute top-0 left-0 right-0 bottom-0 bg-black/50 justify-center opacity-0 hover:opacity-100 transition duration-300 cursor-pointer'>
                    <UploadIcon className='fill-white'/>
                    <p className='text-caption_s_desk'>Сменить</p>
                  </div>
                </div>
