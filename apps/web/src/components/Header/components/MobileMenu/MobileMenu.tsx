	...
	return (
		<ShowOnMobileToTablet>
			<Dialog as="div" open={isOpen} onClose={() => setIsOpen(false)}>
				...
				<Dialog.Panel className="fixed inset-y-0 left-0 z-50 w-full overflow-y-auto bg-popup_gray backdrop-blur ">
					<div className="flex items-center justify-between px-4 md:px-8 py-4 md:py-5 border-b border-medium_grey">
