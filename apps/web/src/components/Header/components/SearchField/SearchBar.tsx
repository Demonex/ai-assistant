                                ...
                                </div>
                                {
                                  isShowAll && (
                                    <Link to={`/all_search_results?q=${value}`}
                                          onClick={() => setIsOpenSearchModal(false)}>
                                      <div
                                        className="w-full px-1 py-5 md:p-5 sticky bottom-0 border-t border-secondary_dark_gray gap-4 group items-center cursor-pointer hidden md:flex">
                                        <p className="text-btnText group-hover:text-medium_grey">Смотреть все
                                          результаты</p>
              ...
              searchData?.length === 0 || !isShowAll
                ...
                >
                  <div
                    ...
                    <p className="text-btnText hover:text-medium_grey">Смотреть все результаты</p>
