...
const Header = memo(() => {
	...
	return (
		<div className="w-full py-4 px-4 pb-3 md:py-5 md:px-8 lg:py-6 lg:px-11 flex border-b border-[#333333]/50 z-40 fixed bg-[#0C0C0C] max-h-[68px] md:max-h-[84px] lg:max-h-[96px]">
			<DropdownAccountMenu />
			<div
