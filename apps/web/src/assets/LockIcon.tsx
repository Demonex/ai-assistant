...
const LockIcon = memo<Props>(({ className }) => {
	return (
		<svg
			width="32"
			height="32"
		...
		>
			...
			/>
			<path
				d="M16 18.666V23.9993"
				stroke="#E4FF29"
				strokeWidth="1.6"
				strokeLinecap="round"
			/>
			<path
				d="M8 13.3327V10.666C8 6.24774 11.5817 2.66602 16 2.66602C20.4183 2.66602 24 6.24774 24 10.666V13.3327"
				stroke=""
				strokeWidth="1.6"
				strokeLinecap="round"
			/>
