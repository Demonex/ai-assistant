...
const content = {
	...
	content: [
		{
			subtitle:
				"Режиссер Мишель Гондри рассказывает о том, почему видео получилось таким, что значат все эти персонажи, кто ставил танцы и прочие секреты съемочной площадки",
			text:
				"В YouTube-канале Daft Punk появилась пара видео о создании классического клипа дуэта «Around The World».\n" +
	...
	return !post || loading ? null : (
		<div className="flex flex-col gap-8">
			<div className="flex flex-col gap-4 ">
				...
				<span className="text-captionText font-normal text-medium_grey mt-1">
					{post?.createdAt &&
						DateTime.fromISO(post.createdAt).toFormat("d MMM yyyy")}
				</span>
			</div>
			<div>
				<img className="rounded-2xl" src={post?.preview?.url} />
				<div
