...
const VioletInterraption = memo(() => {
	...
	const { h1SizeMobile, marginVertical, paddingHorizontal, h1Size } =
		useElementRangeSize();
	const gap = elementRangeLaptop(30, 100);
	const gapVertical = elementRangeMobile(30, 60);
	const spraySize = elementRangeLaptop(160, 240);
	const spraySizeMobile = elementRangeMobile(100, 160);
		...
		>
			...
			>
				<div className="flex gap-[1.25rem] xl:gap-[20px] flex-wrap lg:flex-nowrap justify-center">
					...
					>
						Лови инсайты и&nbsp;выводи своих артистов
