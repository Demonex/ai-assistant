...
import {ChartDataType, ResponseAudienceMapStats, type ResponseAudienceSummery} from '../types.js';
...
const _useArtistAudience = (): {
  ...
  const [{
    ...
    loading,
    error
  }, fetchSummery] = useLazyFetch<ResponseAudienceSummery>({
...
export const useArtistAudienceSummery = () => useSharedHook<ReturnType<typeof _useArtistAudience>>(_useArtistAudience);
