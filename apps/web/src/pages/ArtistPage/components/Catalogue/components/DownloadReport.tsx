...
const DownloadReport = memo(() => {
	const { setOpenPopUp, selectedTrack, setIsRequestSent, isRequestSent } =
		useGetTracks();
					...
					{downloading ? (
						<div className="flex flex-col">
							...
							<div className="flex flex-col gap-4">
								<div className="w-full h-[60px] relative animate-[p4_6s_infinite_steps(10)] rounded-[3px] progress_download-report" />
