	...
	venues: [
		{
			...
			imageUrl:
				"https://i.scdn.co/image/ab6761610000e5eb9420fc7bac8669f61a9f45c3",
			smallImageUrl: false,
			...
			events: [
				{
					...
					eventDescription:
						"Marilyn Manson at Eventim Apollo (February 21, 2025)",
					imageUrl:
						"https://i.scdn.co/image/ab676161000051749420fc7bac8669f61a9f45c3",
		...
		},
		{
			...
			imageUrl:
				"https://i.scdn.co/image/ab6761610000e5ebada11014169e26224ec80f0c",
			smallImageUrl: false,
			countryImageUrl: "https://songstats.com/files/flags/gb.png",
			...
			events: [
				{
					...
					imageUrl:
						"https://i.scdn.co/image/ab67616100005174ada11014169e26224ec80f0c",
		...
		},
		{
			...
			imageUrl:
				"https://i.scdn.co/image/ab6761610000e5ebf9978ad4808f6f2723124d19",
			smallImageUrl: false,
			countryImageUrl: "https://songstats.com/files/flags/gb.png",
			...
			events: [
				{
					...
					artistName: "Slipknot",
					eventDescription:
						"Slipknot with Bleed From Within at The O2 (December 21, 2024)",
					imageUrl:
				...
				},
				{
					...
					artistName: "Slipknot",
					eventDescription:
						"Slipknot with Bleed From Within at The O2 (December 20, 2024)",
					imageUrl:
						"https://i.scdn.co/image/ab67616100005174d0cdb283a7384a0edb665182",
				...
				},
				{
					...
					eventDescription:
						"Iron Maiden and The Raven Age at The O2 (July 8, 2023)",
					imageUrl:
						"https://i.scdn.co/image/ab67616100005174f9978ad4808f6f2723124d19",
				...
				},
				{
					...
					artistName: "Iron Maiden",
					eventDescription:
						"Iron Maiden with Lord of the Lost at The O2 (July 7, 2023)",
					imageUrl:
						"https://i.scdn.co/image/ab67616100005174f9978ad4808f6f2723124d19",
...
const DetailedModal = memo(
	({ setOpenModal, openModal, infoAboutVenue }: any) => {
		return (
			<Transition appear show={openModal} as={Fragment}>
				...
				>
					...
					<div className="h-full">
						...
						>
							<Dialog.Panel className=" bg-popup_gray lg:my-20 p-4 md:py-8 lg:py-10 md:px-8 lg:px-[3.75rem] lg:mx-auto lg:rounded-[20px] z-50 relative w-full lg:max-w-[53.9rem] mb-[7rem] md:mb-[unset] h-auto md:h-full lg:h-[unset]">
								<div
								...
								<div className="flex flex-col gap-6">
									<div className="pb-2 w-full flex flex-col gap-2 border-b border-secondary_dark_gray">
										...
										<div className="flex gap-2.5 items-center text-t2Regular">
											...
											{infoAboutVenue?.metadata?.map((item, index) => (
												<span className={"text-medium_grey"} key={index}>
													{item.displayText}
												</span>
											))}
										</div>
									...
									<div className="flex flex-col gap-4">
										<h2 className="text-caption_s_desk text-medium_grey uppercase">
											О ПЛОЩАДКЕ
										</h2>
										<p className="text-caption_r_desk text-light_grey">
											{infoAboutVenue.description}
										</p>
										<div>
											...
											<p className="text-caption_m_desk text-light_grey">
												Сайт:{" "}
												<Link to={infoAboutVenue.website}>
													{infoAboutVenue.website}
												</Link>
											</p>
										</div>
									</div>
									<div>
										...
										<ul className="mt-2">
											{infoAboutVenue?.events?.map((event, index) => (
												<li
													key={index}
													className="py-2 border-b border-secondary_dark_gray flex gap-4 items-center"
												>
													<img
														src={event.imageUrl}
														alt=""
													...
													/>
													<div>
														<h2 className="text-caption_r_desk">
															{event.artistName}
														</h2>
														<span className="text-caption_s_desk text-medium_grey">
															{event.startDate}
														</span>
													</div>
												</li>
	...
	return (
		<div className="flex flex-col gap-4 mb-[4.5rem]">
			<DetailedModal
				...
				infoAboutVenue={infoAboutVenue}
			/>
			<div className="py-4 flex gap-4 items-center">
				<img src="" alt="" className="w-8 h-8 rounded-lg" />{" "}
				{/*get src from url*/}
				<h1 className="text-t2Regular text-light_grey">
					Москва, Россия: 10 мест
				</h1>
				{/*get src from url*/}
			</div>
			<div className="grid grid-cols-6 gap-x-6">
				{clickedData.venues.map((venue, index) => (
					<div
						className="cursor-pointer p-3 rounded-[0.75rem] bg-[#27272780] flex flex-col gap-4 items-center"
						key={index}
						onClick={() => {
							setOpenModal(true);
					...
					>
						<img
							src={venue.imageUrl}
							alt=""
							className="w-[9.25rem] h-[9.25rem] rounded-[0.75rem]"
						/>
						<div>
