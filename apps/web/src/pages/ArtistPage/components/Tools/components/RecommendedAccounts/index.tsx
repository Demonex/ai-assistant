  ...
  "playlists": [
    {
      ...
      "imageUrl": "https://cdn.songstats.com/instagram_users/images/001/700/619/original/data?1726541952",
    ...
    },
    {
      ...
      "imageUrl": "https://cdn.songstats.com/instagram_users/images/015/007/679/original/data?1721171462",
      "popupType": "instagram_user",
    ...
    },
    {
      ...
      "imageUrl": "https://cdn.songstats.com/instagram_users/images/000/520/010/original/data?1713434944",
      "popupType": "instagram_user",
    ...
    },
    {
      ...
      "imageUrl": "https://cdn.songstats.com/instagram_users/images/020/000/486/original/data?1721791098",
      "popupType": "instagram_user",
    ...
    },
    {
      ...
      "imageUrl": "https://cdn.songstats.com/instagram_users/images/000/500/091/original/data?1721447187",
      "popupType": "instagram_user",
    ...
    },
    {
      ...
      "imageUrl": "https://cdn.songstats.com/instagram_users/images/000/620/026/original/data?1719138781",
      "popupType": "instagram_user",
    ...
    },
    {
      ...
      "imageUrl": "https://cdn.songstats.com/instagram_users/images/025/008/895/original/data?1691546585",
      "popupType": "instagram_user",
    ...
    },
    {
      ...
      "imageUrl": "https://cdn.songstats.com/instagram_users/images/013/001/623/original/data?1726575198",
      "popupType": "instagram_user",
    ...
    },
    {
      ...
      "imageUrl": "https://cdn.songstats.com/instagram_users/images/008/200/589/original/data?1719990640",
      "popupType": "instagram_user",
    ...
    },
    {
      ...
      "imageUrl": "https://cdn.songstats.com/instagram_users/images/022/005/373/original/data?1695324879",
      "popupType": "instagram_user",
    ...
    },
    {
      ...
      "imageUrl": "https://cdn.songstats.com/instagram_users/images/013/013/293/original/data?1691802746",
      "popupType": "instagram_user",
    ...
    },
    {
      ...
      "imageUrl": "https://cdn.songstats.com/instagram_users/images/003/801/655/original/data?1699902164",
      "popupType": "instagram_user",
    ...
    },
    {
      ...
      "imageUrl": "https://cdn.songstats.com/instagram_users/images/042/012/524/original/data?1723752433",
      "popupType": "instagram_user",
    ...
    },
    {
      ...
      "imageUrl": "https://cdn.songstats.com/instagram_users/images/011/015/469/original/data?1694149614",
      "popupType": "instagram_user",
    ...
    },
    {
      ...
      "imageUrl": "https://cdn.songstats.com/instagram_users/images/000/092/019/original/data?1713580951",
      "popupType": "instagram_user",
    ...
    },
    {
      ...
      "imageUrl": "https://cdn.songstats.com/instagram_users/images/041/019/512/original/data?1719313955",
      "popupType": "instagram_user",
    ...
    },
    {
      ...
      "imageUrl": "https://cdn.songstats.com/instagram_users/images/024/022/735/original/data?1716876553",
      "popupType": "instagram_user",
    ...
    },
    {
      ...
      "imageUrl": "https://cdn.songstats.com/instagram_users/images/007/002/859/original/data?1721103554",
      "popupType": "instagram_user",
    ...
    },
    {
      ...
      "imageUrl": "https://cdn.songstats.com/instagram_users/images/001/002/669/original/data?1722956294",
      "popupType": "instagram_user",
    ...
    },
    {
      ...
      "imageUrl": "https://cdn.songstats.com/instagram_users/images/037/022/064/original/data?1729159593",
      "popupType": "instagram_user",
    ...
    },
    {
      ...
      "imageUrl": "https://cdn.songstats.com/instagram_users/images/008/002/413/original/data?1713361021",
      "popupType": "instagram_user",
    ...
    },
    {
      ...
      "imageUrl": "https://cdn.songstats.com/instagram_users/images/018/025/016/original/data?1727734049",
      "popupType": "instagram_user",
    ...
    },
    {
      ...
      "imageUrl": "https://cdn.songstats.com/instagram_users/images/006/402/383/original/data?1724835096",
      "popupType": "instagram_user",
    ...
    },
    {
      ...
      "imageUrl": "https://cdn.songstats.com/instagram_users/images/024/034/399/original/data?1728202389",
      "popupType": "instagram_user",
...
const RecommendedAccounts = memo(() => {
  const sourceArray = navbar[0].content[0].options.filter((source) => source.slug === 'instagram' || source.slug === 'tiktok' || source.slug === 'soundcloud' || source.slug === 'youtube');
  ...
  const [selectedContactOption, setSelectedContactOption] = useState(contactsOptions[0]);
  ...
  return (
    <div className='w-full flex flex-col gap-1'>
      ...
      <div className='py-4 mt-1.5'>
        <p className='text-caption_r_desk text-medium_grey'>В этом разделе ты можешь найти аккаунты, сотрудничающие с похожими исполнителями. </p>
      </div>
      <div className='pt-1 flex gap-4'>
        <div
          className='grid grid-cols-1 md:grid-cols-2 lg:flex gap-4 lg:gap-6 w-fit lg:justify-start lg:flex-wrap lg:items-end'>
          <div className='w-fit'>
            <Listbox value={selectedSource} onChange={setSelectedSource}>
                ...
                {({open}) => (
                  <div
                    ...
                    <div className='flex gap-2 items-center'>
                      <img src={selectedSource.logo} alt='' className='max-w-5'/>
              ...
              >
                <Listbox.Options
                  className='bg-popup_gray z-10 rounded-b-xl  max-w-[330px] absolute w-full'
                >
          ...
          <div className='w-fit'>
            {
              data.filters.contactInfoType !== null && (
                <Listbox value={selectedContactOption} onChange={setSelectedContactOption}>
                  <Listbox.Label className='text-caption_m_desk text-medium_grey '>Контакты</Listbox.Label>
                  <Listbox.Button
                    className='  w-[330px] relative mt-1.5'>
                    {({open}) => (
                      <div
                        className={`flex justify-between items-center w-full text-t2Regular py-2.5 px-3.5  ${open ? ' border-b border-solid border-secondary_dark_gray  bg-popup_gray rounded-t-xl ' : 'border border-solid border-secondary_dark_gray rounded-xl '}`}>
                        <p className='text-t2Regular'>{selectedContactOption.name}</p>
                        <ChevronRight color='#7B7B7B'
                                      className={` w-5 h-5 transition duration-300 ${open ? '-rotate-90 ' : 'rotate-90 transition'}`}/>
                      </div>
                    )}
                  ...
                  >
                    ...
                    >
                      {contactsOptions.map((filter, index) => filter.name !== selectedContactOption.name ? (
                        <Listbox.Option
                          key={index}
                          value={filter}
          ...
          <div className='w-fit'>
            {
              data.filters.followers !== null && (
                <Listbox value={selectedFollowersQtyFilter} onChange={setSelectedFollowersQtyFilter}>
          ...
          <div className='w-fit'>
            {
              data.filters.countryCode !== null && (
                <Listbox value={selectedCountry} onChange={setSelectedCountry}>
                  <Listbox.Label className='text-caption_m_desk text-medium_grey '>Страна</Listbox.Label>
                  <Listbox.Button
                    className='  w-[330px] relative mt-1.5'>
                    {({open}) => (
                      <div
                        ...
                        <div className='flex items-center gap-2'>
                          {selectedCountry.icon && (
                            <img src={selectedCountry.icon} alt='' className='max-w-5'/>
                          )}
                  ...
                  >
                    <Listbox.Options
                      className='bg-popup_gray  rounded-b-xl absolute w-full  max-w-[330px] max-h-[18rem] overflow-y-scroll'
                    >
                      {countries.map((item, index) => item.text !== selectedCountry.text ? (
                        <Listbox.Option
                          key={index}
                          value={item}
        ...
        <ul className='w-full grid grid-cols-1 xl:grid-cols-2 2xl:grid-cols-3 gap-6'>
          {
            data.recommendations.map((item, index) => (
              <li className='w-full bg-[#27272780] rounded-xl p-4 flex justify-between gap-6 flex-col md:flex-row' key={index}
                  onClick={() => setOpenModal(true)}
              >
                <div className='flex gap-4 items-center'>
                  <img src={item.imageUrl} className='w-[3.75rem] h-[3.75rem]  rounded-full'/>
                  <div className='max-w-[15rem]'>
                    <h1 className='text-t2Regular truncate'>{item.primaryText}</h1>
