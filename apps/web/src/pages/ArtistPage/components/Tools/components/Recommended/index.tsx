	...
	playlists: [
		{
			...
			imageUrl:
				"https://image-cdn-ak.spotifycdn.com/image/ab67706c0000da84258f6e8565a2283e9cb223b0",
		...
		},
		{
			...
			imageUrl:
				"https://image-cdn-ak.spotifycdn.com/image/ab67706c0000da84859bc00f706b673dbff7b3bf",
			popupType: "spotify_playlist",
		...
		},
		{
			...
			imageUrl:
				"https://image-cdn-ak.spotifycdn.com/image/ab67706c0000da84c55fc516f776baa3642b8bab",
			popupType: "spotify_playlist",
		...
		},
		{
			id: 6026589,
			primaryText:
				"Rolling Stone Magazine - 500 Greatest Songs of All Time (2021)",
			secondaryText: "Henrik B. Hansen",
			valueText: "20.5K Followers",
			imageUrl:
				"https://image-cdn-ak.spotifycdn.com/image/ab67706c0000da84c9913b7c784b3f6ed70b666c",
			popupType: "spotify_playlist",
		...
		},
		{
			...
			imageUrl:
				"https://image-cdn-ak.spotifycdn.com/image/ab67706c0000da8439f28d1bffefba6bb67045dd",
			popupType: "spotify_playlist",
		...
		},
		{
			...
			imageUrl:
				"https://image-cdn-ak.spotifycdn.com/image/ab67706c0000da84a1916927892b75514f20589d",
			popupType: "spotify_playlist",
		...
		},
		{
			...
			imageUrl:
				"https://image-cdn-ak.spotifycdn.com/image/ab67706c0000da84cb67f8441c363d857a94ab83",
			popupType: "spotify_playlist",
		...
		},
		{
			...
			imageUrl:
				"https://image-cdn-ak.spotifycdn.com/image/ab67706c0000da8465b835a01113f56c4e9ee5aa",
			popupType: "spotify_playlist",
		...
		},
		{
			...
			imageUrl:
				"https://mosaic.scdn.co/120/ab67616d00001e02235f995865eedfb0d9da18c7ab67616d00001e02307782dc8a0b27d0b2f9fa66ab67616d00001e026c1f1d0bcb122102c7d29c50ab67616d00001e028e7b4bf3e1c5f0b20d52e6f9",
			popupType: "spotify_playlist",
		...
		},
		{
			...
			imageUrl:
				"https://image-cdn-fa.spotifycdn.com/image/ab67706c0000da84e735fa910b0705704536427d",
			popupType: "spotify_playlist",
		...
		},
		{
			...
			imageUrl:
				"https://image-cdn-ak.spotifycdn.com/image/ab67706c0000d72c5a3443216df097076bd4bebc",
			popupType: "spotify_playlist",
		...
		},
		{
			...
			imageUrl:
				"https://image-cdn-ak.spotifycdn.com/image/ab67706c0000da846dd941d52102d8effe7b079f",
			popupType: "spotify_playlist",
		...
		},
		{
			...
			imageUrl:
				"https://mosaic.scdn.co/120/ab67616d00001e0205d4eec40a828850aa8cd2f7ab67616d00001e02a1d9c9969f2a7ed27e449a3cab67616d00001e02dc30583ba717007b00cceb25ab67616d00001e02fc4f17340773c6c3579fea0d",
			popupType: "spotify_playlist",
		...
		},
		{
			...
			imageUrl:
				"https://image-cdn-ak.spotifycdn.com/image/ab67706c0000da844357472111ff85dacc03effc",
			popupType: "spotify_playlist",
		...
		},
		{
			id: 5035987,
			primaryText:
				"WAHALA ROOM Hot 100 | Afrobeats 2020 | Dancehall | Afroswing | Bangers 🔥 BaitList",
			secondaryText: "Samuel Ogunkoya",
			valueText: "18K Followers",
			imageUrl:
				"https://image-cdn-ak.spotifycdn.com/image/ab67706c0000da84a45895a1d9b38b2897f3f664",
			popupType: "spotify_playlist",
		...
		},
		{
			...
			imageUrl:
				"https://image-cdn-ak.spotifycdn.com/image/ab67706c0000da84f755ce669e6da97b2b379cc5",
			popupType: "spotify_playlist",
		...
		},
		{
			id: 70460223,
			primaryText:
				"Rock Nostalgia 🎸🤘| Rock Nacional e Internacional | 90' , 2000' , 2010'",
			secondaryText: "Fritz Playlists",
			valueText: "21.7K Followers",
			imageUrl:
				"https://image-cdn-ak.spotifycdn.com/image/ab67706c0000da84dd185796eb245ff719d8052d",
			popupType: "spotify_playlist",
		...
		},
		{
			...
			imageUrl:
				"https://image-cdn-fa.spotifycdn.com/image/ab67706c0000da847c109b865338ce7910c07e86",
			popupType: "spotify_playlist",
		...
		},
		{
			id: 30513,
			primaryText:
				"Paraguay Top 40 - Só Fé, UWAIE, SE ME OLVIDA, Love Me Again, Piel",
			secondaryText: "PLAYLISTED",
			valueText: "10.9K Followers",
			imageUrl:
				"https://image-cdn-ak.spotifycdn.com/image/ab67706c0000d72c36d769ae2bb101bcbcaf1645",
			popupType: "spotify_playlist",
		...
		},
		{
			...
			imageUrl:
				"https://image-cdn-ak.spotifycdn.com/image/ab67706c0000da8462a574a2750c41333f9f0741",
			popupType: "spotify_playlist",
		...
		},
		{
			...
			imageUrl:
				"https://mosaic.scdn.co/120/ab67616d00001e0228b2637e7ca2182a1dbcf8e7ab67616d00001e024a5e7d0c4b87c01cf5dc6519ab67616d00001e02c8a11e48c91a982d086afc69ab67616d00001e02dd507a2a323ee185356b0ef5",
			popupType: "spotify_playlist",
		...
		},
		{
			...
			imageUrl:
				"https://image-cdn-ak.spotifycdn.com/image/ab67706c0000da842339da188e1051ff1b2c6f0b",
			popupType: "spotify_playlist",
		...
		},
		{
			...
			imageUrl:
				"https://mosaic.scdn.co/120/ab67616d00001e028be268d3513e3be254727ab8ab67616d00001e02a82120c595afebd8513a7534ab67616d00001e02cbd1eabeaac100f9507df5caab67616d00001e02f403428ab2a0617b355d4ac7",
			popupType: "spotify_playlist",
		...
		},
		{
			...
			imageUrl:
				"https://image-cdn-ak.spotifycdn.com/image/ab67706c0000da8442af4b05362421d7e9ef7431",
			popupType: "spotify_playlist",
...
const RecommendedPlaylists = memo(() => {
	...
	const [selectedSongReleaseFilter, setSelectedSongReleaseFilter] = useState(
		songReleaseFilter[0],
	);
		...
		<div className="w-full flex flex-col gap-1">
			...
			<div className="py-4 mt-1.5">
				<p className="text-caption_r_desk text-medium_grey">
					В этом разделе ты можешь получить свежие рекомендации по плейлистам с
					похожими исполнителями.
				</p>
			</div>
				...
				<div className="grid grid-cols-1 md:grid-cols-2 lg:flex gap-4 lg:gap-6 w-fit lg:justify-start lg:flex-wrap lg:items-end">
					...
					<div className="w-fit">
						{recommendedData.filters.songPopularityType !== null && (
							<Listbox
								...
								onChange={setSelectedPopularityFilter}
							>
								<Listbox.Label className="text-caption_m_desk text-medium_grey ">
									Популярность
								</Listbox.Label>
								...
								>
									<Listbox.Options className="bg-popup_gray  rounded-b-xl  max-w-[330px] absolute w-full">
										{popularityFilter.map((filter, index) =>
											filter.name !== selectedPopularityFilter.name ? (
												<Listbox.Option
													key={index}
													value={filter}
					...
					<div className="w-fit">
						{recommendedData.filters.songReleaseDateType !== null && (
							<Listbox
								value={selectedSongReleaseFilter}
								onChange={setSelectedSongReleaseFilter}
							>
								<Listbox.Label className="text-caption_m_desk text-medium_grey ">
									Новизна треков
								</Listbox.Label>
								<Listbox.Button className="  w-[330px] relative mt-1.5">
									{({ open }) => (
										...
										>
											<p className="text-t2Regular">
												{selectedSongReleaseFilter.name}
											</p>
											<ChevronRight
												color="#7B7B7B"
												className={` w-5 h-5 transition duration-300 ${open ? "-rotate-90 " : "rotate-90 transition"}`}
								...
								>
									<Listbox.Options className="bg-popup_gray  rounded-b-xl  max-w-[330px] absolute w-full">
										{songReleaseFilter.map((item, index) =>
											item.name !== selectedSongReleaseFilter.name ? (
												<Listbox.Option
													key={index}
													value={item}
													className={`py-2.5 px-5 cursor-pointer ${index === popularityFilter.length - 1 ? "" : "border-b border-secondary_dark_gray"}`}
