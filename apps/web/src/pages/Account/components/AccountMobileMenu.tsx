		...
		<div>
			...
			<ul className="">
				{accountTabs.map((tab, index) => (
					<li
						className="p-6 border-b border-secondary_dark_gray/50 flex justify-between items-center"
						onClick={() => setMobileRender(tab.type)}
						key={index}
					>
				...
				<>
					{mobileRender !== "" && (
						<div className="lg:hidden">
							<div
								className="flex gap-2.5 items-center pb-6"
								onClick={() => setMobileRender("")}
							>
