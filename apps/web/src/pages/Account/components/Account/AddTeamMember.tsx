		...
		<Transition appear show={openModalAdd} as={Fragment}>
			...
			>
				...
				<div className="w-full h-full flex justify-center items-center">
					...
					>
						{sendRequest ? (
							<Dialog.Panel className="h-full md:h-fit bg-popup_gray lg:my-20 p-4 md:py-8 lg:p-10 md:px-8  lg:mx-auto md:rounded-[20px] z-50 relative w-full lg:w-fit md:max-w-[35rem]">
								<div
								...
								<div className="flex flex-col gap-5">
									...
									<div className="flex justify-center">
										<SecondaryButton
											title="Хорошо"
											className="bg-primary_blue border-none text-white w-full md:w-fit"
											onClick={() => setOpenModalAdd(false)}
										/>
									</div>
								</div>
								...
								<div className="flex flex-col gap-5">
									...
									<div className="flex flex-col gap-4">
										<p className="text-caption_r_desk text-medium_grey">
											Укажи email нового участника. Мы вышлем ему приглашение.
										</p>
										<div>
