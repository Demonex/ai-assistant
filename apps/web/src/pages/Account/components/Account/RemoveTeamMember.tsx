...
const RemoveTeamMember = memo(
	({ openModalRemove, setOpenModalRemove }: any) => {
			...
			<Transition appear show={openModalRemove} as={Fragment}>
				...
				>
					...
					<div className="w-full h-full flex justify-center items-center">
						...
						>
							{sendRequestRemoving ? (
								<Dialog.Panel className="h-full md:h-fit bg-popup_gray lg:my-20 p-4 md:py-8 lg:p-10 md:px-8  lg:mx-auto md:rounded-[20px] z-50 relative w-full  md:max-w-[35rem]">
									<div
									...
									<div className="flex flex-col gap-5">
										...
										<div className="flex justify-center">
											<SecondaryButton
												title="Хорошо"
												className="bg-primary_blue border-none text-white w-full"
												onClick={() => setOpenModalRemove(false)}
											/>
										</div>
									</div>
								...
								<Dialog.Panel className="h-full md:h-fit bg-popup_gray lg:my-20 p-4 md:py-8 lg:p-10 md:px-8  md:mx-auto md:rounded-[20px] z-50 relative w-full lg:w-fit md:max-w-[35rem]">
									<div
										className="w-full flex justify-end cursor-pointer"
										onClick={() => setOpenModalRemove(false)}
									>
									...
									<div className="flex flex-col gap-5">
										<h1 className="text-t1Semi_deck pb-4">
											Ты действительно хочешь удалить участника login2?
										</h1>
										<div className=" pb-4">
											<p className="text-caption_r_desk text-medium_grey">
												Он потеряет доступ к данным.
											</p>
										</div>
