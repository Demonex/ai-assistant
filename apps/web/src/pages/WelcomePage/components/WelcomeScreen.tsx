...
const WelcomeScreen = memo(() => {
	...
	return (
		<>
			...
			>
				<div
					className="leftSection w-full flex flex-col gap-8  justify-start"
					style={{
				...
				>
					<div className="">
						<div className="flex gap-[3%]">
							...
							>
								<div className="">
									<div className="w-full h-full bg-yellow absolute -z-10 p-1 md:p-2 -left-1 -top-1 md:-top-2 box-content rounded-[12px]" />
									<img
										style={{
											width: `${spraySize}px`,
										}}
						...
						>
							{" "}
							музыкальной {isMobile || isTablet ? null : <br />}карьерой{" "}
						</h1>
					</div>
						...
						<div>
							<p className=" text-t1Regular">
								<span className="inline-block">
									...
									/>{" "}
									— сервис аналитики данных для представителей музыкальной
									индустрии
								</span>
							</p>
						</div>
					...
					<div className="w-full flex items-center justify-start gap-5">
						...
						>
							<span className="w-full text-medium_grey ellipsis whitespace-nowrap ">
								Найти артиста, лейбл или песню
							</span>
				...
				<img
					src={RRR}
					className="absolute top-0 right-0 max-h-[1910px] "
					style={{
						height: `${RSize}px`,
						zIndex: "-1",
					}}
