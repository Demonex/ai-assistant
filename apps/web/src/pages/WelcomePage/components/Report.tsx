	...
	return (
		...
		>
			<div className="">
				...
				>
					Создавай{isTablet || isMobile ? null : <br />} молниеносно
					{isTablet || isMobile ? null : <br />} отчеты и&nbsp;поражай&nbsp;
					{isTablet ? null : <br />}промоутеров
					{isTablet || isMobile ? null : <br />} своими
					<br />
			...
			<div className="">
				<img
					src={imgReport}
					style={{
						maxWidth: isMobile || isTablet ? "100%" : `${imgKnowSize}px`,
					}}
				/>
			</div>
		</div>
