...
const Start = memo(() => {
	const { h1Size, paddingHorizontal, h1SizeMobile, marginVertical } =
		useElementRangeSize();
		...
		<>
			...
			>
				<div className="w-full lg:w-1/2">
					...
					>
						Следи за взлетом
						<br /> прослушиванийи оценивай,
						<br /> насколько бомбическим <br />
					</h1>
					<h1
						className="relative text-h2Desctop w-fit font-bold lg:font-black"
						style={{
							fontSize:
								isMobile || isTablet ? `${h1SizeMobile}px` : `${h1Size}px`,
						}}
					>
						...
						<img
							src={marker}
							className="absolute w-[40%] right-0 -bottom-[10px] md:-bottom-[20px]"
						/>
					</h1>
				</div>
				<div>
