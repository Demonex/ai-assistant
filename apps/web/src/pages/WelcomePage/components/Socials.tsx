		...
		>
			<div className="w-full">
				...
				>
					...
					по трекам из плейлистов,&nbsp;{isTablet || isMobile ? null : <br />}
					чартов, стриминговых&nbsp;{isTablet || isMobile ? null : <br />}
					сервисов и&nbsp;соцсетей
				</h1>
			</div>
			<div className=" flex flex-col gap-5 w-full">
				...
				/>
				<span className="text-medium_grey text-xs leading-[19.5px] lg:w-5/6">
