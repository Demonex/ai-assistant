...
const questions = [
  {
    ...
    description: 'Rifify — это аналитический сервис, разработанный специально для музыкантов, музыкальных лейблов и их команд. Он помогает собирать и анализировать данные о прослушиваниях, популярности треков, взаимодействии с фанатами'
  },
  {
    title: 'Какие ключевые функции сервиса?',
      description: <p>Rifify отслеживает данные с популярных платформ
        <br/>
        ООповещения в реальном времени
        <br/>
          ИПростота интерфейса и легкость в использовании<br/>
        Сервис позволяет отслеживать в какие популярные плейлисты попадает музыка
        <br/>
        </p>
  },
  {
    title: 'Какие данные использует сервис?',
    description: 'Rifify использует комплексные данные из различных источников: информация о количестве прослушиваний на известных платформах, данные о местоположении слушателей, информация о вовлеченности в социальных сетях и плейлистах'
  },
  {
    title: 'Какие тарифы у сервиса ?',
    description: <p>Сервис предлагает тарифный план и скидки в зависимости от количества подписок, включая бесплатный демо - доступ. Информацию о тарифах можно найти <a href='http://rifify.me/#tariffes' target='_blank' className='underline' rel="noreferrer">здесь</a></p>
  },
  {
    title: 'Кому еще будет интересен сервис кроме музыкантов ?',
    description: 'Фанаты могут использовать Rifify для более глубокого знакомства с артистами и их музыкой и следить за популярностью любимых треков и альбомов на популярных платформах'
  },
  {
    title: 'Как мне связаться со службой поддержки Rifify?',
    description: 'Вы можете связаться с нашей службой поддержки по электронной почте support@rifify.me'
  },
  {
    title: 'Что входит в бесплатный демо - доступ?',
    description: 'В бесплатный демо-доступ Rifify входит ограниченный доступ к аналитике и каталогу'
  },
]
const FAQ = memo(() => {
