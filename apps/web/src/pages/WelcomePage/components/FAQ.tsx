...
const questions = [
  ...
  },
  {
    ...
    description: <p>Сервис предлагает тарифный план и скидки в зависимости от количества подписок, включая бесплатный демо - доступ. Информацию о тарифах можно найти <a href='http://rifify.me/#tariffes' target='_blank' className='underline'>здесь</a></p>
  },
  {
