...
const BottomBeforeFooter = ({
	tildaColor,
	children,
	fillPath,
}: BottomBeforeFooterProps) => {
	...
	return (
		<div
			...
			style={{
				minHeight:
					isTablet || isMobile ? `${hiddenDivMobile}px` : `${hiddenDiv}px`,
		...
		>
			<img
				src={bottomImg}
				className="absolute w-full left-1/2 -translate-x-1/2 top-8 z-20"
				style={{
					width: `${imageSize}px`,
				}}
			/>
