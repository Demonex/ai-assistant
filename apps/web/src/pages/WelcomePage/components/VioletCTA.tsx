...
const VioletCTA = memo(() => {
	const { h1SizeMobile, marginVertical, paddingHorizontal } =
		useElementRangeSize();
		...
		>
			...
			>
				...
				<div className="w-full flex items-center justify-center lg:justify-start gap-5">
					...
					>
						<span className="w-full text-light_grey ellipsis whitespace-nowrap text-[1.125rem] leading-[150%]">
							{isMobile
								? "Артист, лейбл или песня"
