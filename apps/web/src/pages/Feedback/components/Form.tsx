...
const Form = memo(() => {
	...
	return (
		<div className="flex flex-col gap-4">
			<div className="flex flex-col gap-4">
				<h1 className="text-2xl lg:text-[2rem] leading-[150%] font-medium">
					Обратная связь
				</h1>
				<div>
					<p className="text-captionText font-normal text-medium_grey">
						Оставь свои контакты и мы скоро свяжемся с тобой
					</p>
					<p className="text-captionText font-normal text-medium_grey">
						Или напиши нам на почту{" "}
						<span className="text-white">supporrifify@gmail.com.</span>
					</p>
				</div>
			</div>
			<form className="flex flex-col gap-4">
				...
				/>
				<Input labelName="Email" type="email" placeholder="example@gmail.com" />
				<Input
