...
export const SubHeroCompanies = memo(() => {
	...
	return (
		<div className="flex justify-center flex-wrap lg:text-center gap-4 md:gap-6  list-none lg:gap-12 max-w-[1024px] p-5">
			{allOptions.map((option, index) => (
				...
				>
					<div className="bg-gray-900 p-[22px] md:px-8 lg:py-8 h-full w-full rounded-3xl inline-flex items-center">
						<img
							src={option.logo}
							alt=""
							className="w-[19px] h-[19px] md:w-[35px] md:h-[35px]"
						/>
					</div>
				</Link>
			))}
