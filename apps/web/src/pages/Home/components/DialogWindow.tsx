	...
	return (
		<div className="flex-grow">
			<div className="fixed inset-0 z-50 flex flex-col bg-background p-4 lg:relative lg:bg-transparent lg:p-0">
				<div className="flex justify-between gap-4">
					<div className="flex gap-4">
						...
						<div className="flex flex-col">
							<span className="font-semibold">Боба Бовович</span>
										...
										<div className="flex items-center gap-2">
											<div className="shadow-base rounded-lg border bg-card text-card-foreground">
												<div className="inline-flex p-4">
													...
													trust me ;) I know how important this file is to you.
													You can trust me ;) know how important this file is to
				...
				<div className="shadow-base rounded-lg border bg-card text-card-foreground">
					<div className="relative flex items-center p-2 lg:p-4">
						<input
							className="flex h-10 w-full rounded-md border bg-background px-3 py-2 text-sm file:border-0 file:bg-transparent file:text-sm file:font-medium placeholder:text-muted-foreground focus:border-primary focus-visible:outline-none disabled:cursor-not-allowed disabled:opacity-50 border-transparent pe-32 !text-base !shadow-transparent !ring-transparent lg:pe-56"
