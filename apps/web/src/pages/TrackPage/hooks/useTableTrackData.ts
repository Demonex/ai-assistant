...
const _useTableTrackData = (): {
	...
	const [{ data: chartTrackData, loading, error }, fetchData] =
		useLazyFetch<ChartTrackDataType>({
...
export const useTableTrackData = () =>
	useSharedHook<ReturnType<typeof _useTableTrackData>>(_useTableTrackData);
