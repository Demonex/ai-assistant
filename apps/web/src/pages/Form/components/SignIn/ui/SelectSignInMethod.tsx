	...
	return (
		<div className="w-full border border-dark_grey rounded-[30px] p-1.5 flex justify-between relative">
			<button
				...
				className={`px-10 py-2 rounded-[22px] w-1/2 text-btnText z-20  whitespace-nowrap ${signInOption === "email" ? "text-[white]  transition duration-200" : "text-medium_grey "}`}
			>
				По email
			</button>
			<button
				onClick={() => setSignInOption("socials")}
