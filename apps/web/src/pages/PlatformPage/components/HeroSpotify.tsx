...
import pattern from "/assets/svg/pattern+logoSpotify.svg";
import tilda from "/assets/svg/iconTilda.svg";
import img from "/assets/png/SpotifyIMG.png";
import { advantages } from "../const.js";
import { SmallTilda } from "../../../assets/SmallTilda.js";

const HeroSpotify = memo(() => {
	const {
		paddingHorizontal,
		marginVertical,
		h1Size: h2Size,
		...
		<>
			...
			>
				...
				>
					...
					>
						Вся статистика твоих треков в Spotify
					</h1>
