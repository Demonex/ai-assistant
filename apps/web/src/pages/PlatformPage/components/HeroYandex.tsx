...
import pattern from "/assets/svg/yandex_pattern.svg";
import img from "/assets/png/yandex_IMG.png";
import { advantages } from "../const.js";
import { SmallTilda } from "../../../assets/SmallTilda.js";

const HeroYandex = memo(() => {
	const {
		paddingHorizontal,
		marginVertical,
		h1Size: h2Size,
				...
				<div className="w-full flex flex-col gap-5 md:gap-8">
					...
					<div className="flex flex-col gap-4">
						{advantages.map((advantage, i) => (
							...
							>
								<SmallTilda className="inline-block mr-3.5" fill="#FED42B" />
