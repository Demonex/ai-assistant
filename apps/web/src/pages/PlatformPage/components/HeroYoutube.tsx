...
import pattern from "/assets/svg/youtubePattern.svg";
import tilda from "/assets/svg/iconTilda_dark_Green.svg";
import img from "/assets/png/youtubeIMG.png";
import { advantages } from "../const.js";
import { SmallTilda } from "../../../assets/SmallTilda.js";

const HeroYoutube = memo(() => {
	const {
		paddingHorizontal,
		marginVertical,
		h1Size: h2Size,
		...
		<>
			...
			>
				...
				>
					...
					>
						Вся статистика твоих треков в&nbsp;YouTube
					</h1>
				...
				<div className="w-full flex flex-col gap-5 md:gap-8">
					...
					<div className="flex flex-col gap-4">
						{advantages.map((advantage, i) => (
							...
							>
								<SmallTilda className="inline-block mr-3.5" fill="#1FD660" />
