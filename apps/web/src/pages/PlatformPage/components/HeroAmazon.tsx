...
import pattern from "/assets/svg/amazonPattern.svg";
import tilda from "/assets/svg/iconTildaPink.svg";
import img from "/assets/png/amazonImg.png";
import { advantages } from "../const.js";
import { SmallTilda } from "../../../assets/SmallTilda.js";

const HeroAmazon = memo(() => {
	const {
		paddingHorizontal,
		marginVertical,
		h1Size: h2Size,
		...
		<>
			...
			>
				...
				>
					...
					>
						Вся статистика твоих треков в&nbsp;Amazon Music
					</h1>
				...
				<div className="w-full flex flex-col gap-5 md:gap-8">
					...
					<div className="flex flex-col gap-4">
						{advantages.map((advantage, i) => (
							...
							>
								<SmallTilda className="inline-block mr-3.5" fill="#E46BFC" />
