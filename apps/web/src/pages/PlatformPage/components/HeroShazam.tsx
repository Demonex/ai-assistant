						...
						<div>
							<p className=" text-t1Regular">
								<span className="inline-block">
									...
									<br /> для представителей музыкальной индустрии
								</span>
							</p>
						</div>
					</div>
