...
import pattern from "/assets/svg/deezerPattern.svg";
import tilda from "/assets/svg/iconTildagreen.svg";
import img from "/assets/png/deezerImg.png";
import { advantages } from "../const.js";
import { SmallTilda } from "../../../assets/SmallTilda.js";

const HeroDeezer = memo(() => {
	const {
		paddingHorizontal,
		marginVertical,
		h1Size: h2Size,
		h1SizeMobile: h2SizeMobile,
	} = useElementRangeSize();
		...
		<>
			...
			>
				...
				>
					...
					>
						Вся статистика твоих треков в Deezer
					</h1>
						...
						<div>
							<p className=" text-t1Regular">
								<span className="inline-block">
									...
									/>{" "}
									— сервис аналитики данных <br />
									для представителей музыкальной индустрии
								</span>
							</p>
						</div>
					</div>
				...
				<div className="w-full flex flex-col gap-5 md:gap-8">
					...
					<div className="flex flex-col gap-4">
						{advantages.map((advantage, i) => (
							<div
								className="text_inline font-medium leading-[150%]"
								key={i}
								style={{
									fontSize: isMobile ? `${pSize}px` : `${pSize}px`,
								}}
							>
								<SmallTilda className="inline-block mr-3.5" fill="#EB5757" />
