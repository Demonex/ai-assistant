...
import pattern from "/assets/svg/traxsource_pattern.svg";
import img from "/assets/png/traxsource_IMG.png";
import { advantages } from "../const.js";
import { SmallTilda } from "../../../assets/SmallTilda.js";

const HeroTraxsource = memo(() => {
	const {
		paddingHorizontal,
		marginVertical,
		h1Size: h2Size,
