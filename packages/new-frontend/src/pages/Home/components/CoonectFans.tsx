...
export const ConnectFans = memo(() => {
    return (
        <section className='relative'>
            <div className="relative items-center w-full px-5 py-12 mx-auto md:px-12 laptop:py-0">
                <div className="relative flex-col items-start m-auto align-middle">
                    <div className="grid grid-cols-1 gap-12 lg:grid-cols-2 lg:gap-24 ">
                        <div
                            className=" flex flex-col laptop:h-full laptop:flex laptop:justify-center w-full mt-6 laptop:aspect-square lg:mt-0 lg:order-first">
                            <img src={img} alt=''
                        ...
                        <div className="relative items-center gap-12 m-auto lg:inline-flex order-first ">
                            <div className="max-w-xl desktop:max-w-3xl text-center lg:text-left">
                                <div>
                                    <p
                                        className=" text-3xl font-medium tracking-tight text-white sm:text-3xl laptop:text-5xl desktop:text-5xl ">
                                        Connect with your fans.
                                    </p>
                                    <p className="mt-8 text-base laptop:text-[1.125rem] laptop:max-w-[500px] font-normal tracking-tight text-gray-300 px-10 laptop:px-0">Share
                                        your accomplishments directly to your socials and build on your momentum.</p>
                                </div>
            ...
            <div>
                <svg className="absolute blur-3xl opacity-80 -left-[34rem] -bottom-[33rem] -z-10" width="100%"
                     height="100%"
