...
export const InsightsSection = memo(() => {
    return (
        <section className='relative'>
            <div
                className="relative items-center w-full px-5 py-16 mx-auto md:px-12 lg:pb-0 laptop:pt-32 desktop:pt-24 2xl:pt-16">
                    ...
                    <div className="grid grid-cols-1 gap-16 lg:grid-cols-2 lg:gap-24">
                        <div className="relative items-center gap-12 m-auto lg:inline-flex order-first ">
                            <div className="max-w-xl desktop:max-w-3xl text-center lg:text-left">
                                <div>
                                    <p
                                        className="text-3xl font-medium tracking-tight text-white sm:text-3xl laptop:text-5xl desktop:text-5xl whitespace-nowrap">
                                        Insights that move you.
                                    </p>
                                    <p className="mt-8 text-base laptop:text-[1.125rem] laptop:max-w-[500px] font-normal tracking-tight text-gray-300 px-10 laptop:px-0">Receive
                                        push notifications for new playlist adds, chart positions and feature
                                        placements.</p>
                                </div>
                        ...
                        <div
                            className="order-first flex flex-col laptop:h-full laptop:flex laptop:justify-center w-full mt-4 laptop:aspect-square lg:mt-0">
                            <img src={img} alt=''
            ...
            <div>
                <svg className="absolute blur-3xl opacity-80 right-0 top-0 -mt-20 -z-10" width="70%" height="70%"
                    ...
                    <defs>
                        <filter id="filter0_f_17_60" x="-159.933" y="-159.933" width="719.867" height="719.867"
                            ...
                            <feGaussianBlur stdDeviation="79.9667"
