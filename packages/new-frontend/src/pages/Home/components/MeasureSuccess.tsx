                        ...
                        <div className="relative items-center gap-12 m-auto lg:inline-flex order-first ">
                            <div className="max-w-xl desktop:max-w-3xl text-center lg:text-left">
                                <div>
                                    ...
                                    <p className="mt-8 text-base laptop:text-[1.125rem] laptop:max-w-[500px] font-normal tracking-tight text-gray-300 px-10 laptop:px-0">Stay
                                        on top of the DSPs and monitor your streams, playlist reach and engagement.</p>
                                </div>

                            </div>
                        </div>
                        <div
                            className="order-first flex flex-col laptop:h-full laptop:flex laptop:justify-center w-full mt-12 laptop:aspect-square lg:mt-0">
                            <img src={img} alt=''
