        ...
        <div
            ...
            <div className='w-full flex flex-col justify-center items-center'>
                <Tab.Group>
                    ...
                    >
                        <div className=' flex justify-center items-center p-1 rounded-[30px] border border-medium_grey gap-3.5'>
                            {
                                ...
                                content[0].options.map((tariff, index) => (
                                    <div
                                        ...
                                        <div className='flex flex-col '>
                                            <h1 className='text-xl leading-[110%] font-medium md:text-h3Desctop z-30 relative text-[black] text-center'>{tariff.title}</h1>
                                            <div
                                                        ...
                                                        index === content.length - 1
                                                            ...
                                                            : <>
                                                                <li className='flex gap-3 items-center'>
                                                                    ...
                                                                    <p className='text-[3.5rem] leading-[110%] font-light whitespace-nowrap'>{tariff.price}</p>
                                                                </li>
