...
export const SignUpPage = memo(() => {
  ...
  const [{data, loading, error}, fetchSignUp] = useLazyFetch({
  ...
  return profile ? (
    ...
    <>
      ...
      <section
        className={`relative flex  justify-center tablet:items-center tablet:h-screen `}
      >
        <div className="flex min-h-full flex-1 flex-col justify-center py-12 sm:px-6 lg:px-8">
          <div className="sm:mx-auto sm:w-full sm:max-w-md mt-3 md:mt-[18rem]">
                ...
                <div>
                  ...
                  <div className="mt-2">
                    <input
                      type="email"
                      autoComplete="email"
                      className={`block w-full rounded-md border-0 bg-white/5 py-1.5 px-3 text-white shadow-sm  sm:text-sm sm:leading-6 ${errors.email ? ' ring-1 ring-inset ring-[#ff1749] focus:ring-inset focus:ring-[#ff1749]' : 'ring-1 ring-inset ring-white/10 focus:ring-2 focus:ring-inset focus:ring-indigo-500'} `}
                ...
                <div>
                  ...
                  <div className="mt-2">
                    <input
                      ...
                      className={`block w-full rounded-md border-0 bg-white/5 py-1.5 px-3 text-white shadow-sm ${errors.password ? ' ring-1 ring-inset ring-[#ff1749] focus:ring-inset focus:ring-[#ff1749]' : 'ring-1 ring-inset ring-white/10 focus:ring-2 focus:ring-inset focus:ring-indigo-500'} sm:text-sm sm:leading-6`}
              ...
              <div>
                <div className="relative mt-10">
                  ...
                  <div className="relative flex justify-center text-sm font-medium leading-6">
                    <span
                      className="rounded-md px-6 text-white">Or continue with</span>
                  </div>
                </div>
