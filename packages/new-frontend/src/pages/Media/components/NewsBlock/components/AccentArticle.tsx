...
const AccentArticle = memo(() => {
    ...
    return (
        <div className='py-5'>
            <div className='bg-popup_gray rounded-2xl p-5 lg:p-8'>
                            ...
                            <div className='flex flex-col gap-4'>
                                ...
                                <div className='flex flex-col gap-4'>
                                    <h1 style={{
                                        ...
                                        className='text-h2Mobile md:text-h2Medium lg:text-h2Desctop line-clamp-2 lg:line-clamp-3'>{news.title}</h1>
                                    <p className='text-t2Regular line-clamp-2 lg:line-clamp-3'>{news.subtitle}</p>
                                </div>
                            </div>
                            <div className=''>
                                <span className='text-captionText text-medium_grey font-normal'>{news.date}</span>
                            </div>
                        </div>
                    </Link>
                    <div style={{
