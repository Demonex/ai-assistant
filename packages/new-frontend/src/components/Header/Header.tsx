  ...
  return (
    <>
      ...
      <div className="w-screen fixed z-20">
        <header
          className=" bg-[#15172300]/20 backdrop-blur-2xl border-b border-[#ffff]/10 relative h-[75px] w-full">
          <nav className="h-full mx-auto flex  items-center justify-between p-3 lg:px-8 gap-4"
               aria-label="Global">
