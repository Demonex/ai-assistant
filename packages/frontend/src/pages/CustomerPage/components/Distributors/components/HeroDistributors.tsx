...
import pattern from "/assets/png/pattern_distr.png";
import spray from "/assets/svg/sprayBlue.svg";
import React, {memo} from "react";
import {useElementRangeSize} from "../../../../../hooks/useElementRangeSize.js";
import {useSizes} from "../../../../../hooks/useSizes.js";

const HeroManagers = memo(() => {
    ...
    const spraySize = elementRangeLaptop(520, 708);
    const spraySizeMob = elementRangeMobile(340, 520);
        ...
        <>
            <div
                ...
                <div
                    ...
                    className='flex flex-col gap-8 w-fit max-w-[850px]'>
                    <h1 style={{
                    ...
                    <div className='flex items-start flex-col '>
                        <p className='text-2xl leading-[150%]'>
                            Анализируй треки своих артистов в одном сервисе<br/>
                            и принимай обоснованные решения для их развития
                        </p>
                    </div>
                </div>
