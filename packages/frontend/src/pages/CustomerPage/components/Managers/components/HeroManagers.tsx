...
import pattern from "/assets/png/managersPattern.png";
import spray from "/assets/svg/sprayOrange.svg";
...
const HeroManagers = memo(() => {
    ...
    const spraySize = elementRangeLaptop(420, 545);
    const spraySizeMob = elementRangeMobile(240, 420);
