...
export const ErrorPage = () => {
  return (
    <section className="relative h-screen">
      <div
        className="w-full h-screen -z-1 absolute flex flex-row justify-between left-0 lg:h-full lg:max-w-7xl lg:px-0 mx-auto px-6 right-0">
        ...
        <div className="relative items-center w-full px-5 py-24 mx-auto md:px-12 lg:px-16 max-w-7xl lg:pb-32 lg:pt-56">
          <div className="text-left sm:text-center">
            ...
            <p className="max-w-2xl mx-auto mt-4 text-gray-300">
              This page does not exist or it was removed.<span className="block">
