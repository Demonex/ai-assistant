                ...
                <div className="w-full">
                  {
                    loading === true
                      ...
                      : (
                        <div
                          className="w-full flex flex-col justify-center items-center gap-6 py-6 px-4 lg:p-8 mt-8 mb-4 md:py-6 md:my-6 rounded-xl border border-secondary_dark_gray">
                          <div className=" flex flex-col justify-center items-center gap-4">
                            <div className="flex items-center gap-4">
                              <LockIcon className="stroke-yellow min-w-8"/>
                              <h1 className="text-t1Mobile md:text-t1Regular text-light_grey">Активность за последние 30
                                дней недоступна</h1>
                            </div>
                            {
                              !profile
                                ? <p className="text-t2Regular text-medium_grey text-center">Войдите или
                                  зарегистрируйтесь,
                                  чтобы получить доступ к подписке.</p>
                                : !isSubscribed && (
                                <p className="text-t2Regular text-medium_grey text-center">Подпишись на артиста, чтобы
                                  пользоваться всеми возможностями ленты и получать уведомления о новых действиях!</p>
                              )
                            }
                                  ...
                                  <div
                                    ...
                                    <div
                                      ...
                                      <div className="flex flex-col-reverse md:flex-row gap-2 md:gap-4 overflow-hidden">
                                        ...
                                        <h4
                                          className="text-caption_r_desk text-medium_grey whitespace-nowrap overflow-ellipsis overflow-hidden">{item.actionDescriptorText || item.activity_text}</h4>
                                      </div>
