...
const popupData = {
  ...
  "popupInfo": {
    ...
    "name": "All New Metal",
    "imageUrl": "https://mosaic.scdn.co/120/ab67616d00001e023be704afb12805f8358b6d4dab67616d00001e02658c23d13dd933df7dc8d874ab67616d00001e028b6586da8313fae8dff2f12eab67616d00001e02d7e445d525503f3377863209",
    "contactInfo": [
      {
    ...
    "featuredArtists": [
      ...
      },
      {
        ...
        "idUnique": "w1s8tvek",
        "name": "Judas Priest",
        "imageUrl": "https://i.scdn.co/image/ab676161000051744b3cfc24737acb15e73e8bd6",
      ...
      },
      {
        ...
        "idUnique": "tkq5gwp1",
        "name": "Ghost",
        "imageUrl": "https://i.scdn.co/image/ab676161000051742518768732e7215a9f765ca8",
      ...
      },
      {
        ...
        "idUnique": "hcp5eaoi",
        "name": "In Flames",
        "imageUrl": "https://i.scdn.co/image/ab676161000051745c3bd919d1344a738af14136",
      ...
      },
      {
        ...
        "idUnique": "zm6cuyqa",
        "name": "Serj Tankian",
        "imageUrl": "https://i.scdn.co/image/ab676161000051745e304e5c1968ca518011749d",
      ...
      },
      {
        ...
        "idUnique": "3q47evwn",
        "name": "Avatar",
        "imageUrl": "https://i.scdn.co/image/ab67616100005174855109a43a9e095d91916955",
      ...
      },
      {
        ...
        "idUnique": "vix0lcp6",
        "name": "The Hu",
        "imageUrl": "https://i.scdn.co/image/edaf8d77b3a916a071de63e50007c3483c33a75e",
      ...
      },
      {
        ...
        "idUnique": "txf0oz1s",
        "name": "Linkin Park",
        "imageUrl": "https://i.scdn.co/image/ab67616100005174c7e6bd9e65eab62a53355576",
      ...
      },
      {
        ...
        "imageUrl": "https://i.scdn.co/image/ab67616100005174e7c9399d0b5d813c20cbec65",
      ...
      },
      {
        ...
        "idUnique": "dsu1i7a5",
        "name": "BABYMETAL",
        "imageUrl": "https://i.scdn.co/image/ab676161000051742c0d80b9de67c2819bb4dbc0",
      ...
      },
      {
        ...
        "idUnique": "mqvfli1o",
        "name": "Ice Nine Kills",
        "imageUrl": "https://i.scdn.co/image/ab67616100005174e8119ccdb928a59489dada04",
      ...
      },
      {
        ...
        "idUnique": "z8earimd",
        "name": "The HU",
        "imageUrl": "https://i.scdn.co/image/ab676161000051742ccdc24acf91ba14b1b2273a",
      ...
      },
      {
        ...
        "imageUrl": "https://i.scdn.co/image/ab67616100005174e7dfdfea3ce04c4a660baaf2",
      ...
      },
      {
        ...
        "idUnique": "cpjx8bv3",
        "name": "Bad Wolves",
        "imageUrl": "https://i.scdn.co/image/ab67616100005174aea7af79e09a90e00aa5952a",
      ...
      },
      {
        ...
        "idUnique": "h4di0nkl",
        "name": "Powerman 5000",
        "imageUrl": "https://i.scdn.co/image/ab676161000051740f957682f8d10f3cc8c81b69",
      ...
      },
      {
        ...
        "idUnique": "dwjksyb0",
        "name": "Lacuna Coil",
        "imageUrl": "https://i.scdn.co/image/ab67616100005174217481d42438a6eaaa1d450e",
      ...
      },
      {
        ...
        "idUnique": "dyk9blq8",
        "name": "Tom Morello",
        "imageUrl": "https://i.scdn.co/image/ab67616100005174a824aca6e278acca89bc406b",
      ...
      },
      {
        ...
        "imageUrl": "https://i.scdn.co/image/ab676161000051748138046dbc917588b96bfc72",
...
const TrackModal = memo(({openModal, setOpenModal}: any) => {
  const findIcon = navbar[0].content[0].options.find((icon) => icon.slug === popupData.sourceId)
  return (
    <Transition appear show={openModal} as={Fragment}>
      <Dialog as="div" className="fixed inset-0 z-40 overflow-y-auto" onClose={() => setOpenModal(false)}>
        ...
        <div className="h-full">
          ...
          >
            <Dialog.Panel
              className=" bg-popup_gray lg:my-20 p-4 md:py-8 lg:py-10 md:px-8 lg:px-[3.75rem] lg:mx-auto lg:rounded-[20px] z-50 relative w-full lg:max-w-[60rem] mb-[7rem] md:mb-[unset] h-auto md:h-full lg:h-[unset]"
            >
              ...
              <div className='flex flex-col gap-6'>
                <div className='pb-2 flex gap-6 flex-col md:flex-row'>
                  <img src={popupData.popupInfo.imageUrl} className='w-[5rem] h-[5rem] rounded-full'/>
                  <div className='flex flex-col gap-2'>
                    <h1 className='text-t1Semi_mob md:text-t1Semi_deck'>{popupData.popupInfo.name}</h1>
                    <div className='flex gap-2 flex-wrap'>
                      {
                        popupData.popupInfo.metadata.map((item, index) => (
                          <div key={index} className='flex items-center gap-2'>
                            ...
                            <p
                              className={`text-t2Regular ${index === 0 ? 'text-light_grey' : index === 1 ? 'text-white' : 'text-medium_grey'}`}>{item.displayText}
                              {
                ...
                <div className='flex gap-4 md:gap-6 flex-col md:flex-row'>
                  <div className='w-full'>
                    <label className='text-caption_s_desk text-medium_grey'>О ПЛЕЙЛИСТЕ</label>
                    <ul className='mt-4'>
                      {
                        popupData.popupInfo.basicInfo.map((item, index) => (
                          <li className='flex gap-2 mb-0.5' key={index}>
                            <p className='text-caption_m_desk text-light_grey whitespace-nowrap'>{item.key} :</p>
                            <p className='text-caption_m_desk text-light_grey'>{item.value}</p>
                          </li>
                        ))
                      }
                    </ul>
                  ...
                  <div className='w-full'>
                    <label className='text-caption_s_desk text-medium_grey'>КОНТАКТЫ</label>
                    <ul className='mt-4'>
                      {
                        popupData.popupInfo.contactInfo.map((item, index) => (
                          <li className='flex gap-2 mb-0.5 items-center' key={index}>
                            <img src={findIcon.logo} className='w-5 h-5'/>
                            <Link to={item.url} className='text-t2Regular'>{item.displayText}</Link>
                          </li>
                        ))
                      }
                    </ul>
                  ...
                  <ul className='grid grid-cols-1 md:grid-cols-2 gap-x-6 mt-2 '>
                    {
                      popupData.popupInfo.featuredArtists.map((item, index) => (
                        <li key={index} className='py-2 flex gap-4 items-center border-b border-secondary_dark_gray'>
                          <img src={item.imageUrl} className='w-11 h-11 rounded-full' />
                          <div className='w-2/3'>
                            <h3 className='text-t2Regular whitespace-nowrap truncate'>{item.trackTitle}</h3>
                            <p className='text-caption_s_desk text-medium_grey'>{item.name}</p>
                          </div>
                        </li>
                      ))
                    }
