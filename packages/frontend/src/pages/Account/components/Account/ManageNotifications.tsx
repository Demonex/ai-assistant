  ...
  return (
    <section className='py-10 flex flex-col gap-6'>
      ...
      <div className=' flex flex-col gap-4'>
        ...
        <p className='text-caption_r_desk text-medium_grey ml-7'>Письма приходят однократно в день запуска обновления</p>
      </div>
      <div className=' flex flex-col gap-4'>
        <div className=' flex gap-2.5 items-center'>
          <input
      ...
      <SecondaryButton title='Сохранить изменения' className='bg-medium_grey text-white w-fit'/>
    </section>
  )
})
