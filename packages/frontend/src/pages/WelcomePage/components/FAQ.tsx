...
const questions = [
  ...
  },
  {
    ...
    description: <p>Сервис предлагает тарифный план и скидки в зависимости от количества подписок, включая бесплатный демо - доступ. Информацию о тарифах можно найти <a href='http://rifify.ru/#tariffes' target='_blank' className='underline'>здесь</a></p>
  },
  {
  ...
  },
  {
    ...
    description: 'Вы можете связаться с нашей службой поддержки по электронной почте support@rifify.ru'
  },
  {
