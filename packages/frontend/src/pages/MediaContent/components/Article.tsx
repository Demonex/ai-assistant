    ...
    return (
        <div className='flex flex-col gap-8'>
            <div className='flex flex-col gap-4 '>
                ...
                <span className='text-captionText font-normal text-medium_grey mt-1'>{content.date}</span>
            </div>
            <div>
                        ...
                        content.content.map((item, index) => {
                            ...
                            return (
                                <div key={index} className='flex flex-col gap-4 '>
                                    <h2 className={`${index === 0 ? 'text-t1Regular' : 'text-[2rem] font-medium leading-[110%]'}`}>{item.subtitle}</h2>
                                                ...
                                                elem.includes(fileExtension) && (
                                                    <div className='relative' key={mediaIndex}>
                                                        <video muted className='rounded-2xl' src={item.mediaContent}
                                                               ref={videoRef}/>
                                                        <div className={`w-full h-full absolute top-0 left-0 bg-[black]/40 ${isPlaying ? 'opacity-0 transition duration-200' : ''}`}/>
                                                        <button
