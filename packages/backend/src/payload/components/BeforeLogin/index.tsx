...
const BeforeLogin: React.FC = () => {
    ...
    const [appleUrl, setAppleUrl] = React.useState(null)
    React.useEffect(() => {
        (async () => {
            const {data: {url}} = await axios.get<{ url: string | null }>(`${serverURL}/api/rest/auth/provider/apple/link`)
            setAppleUrl(url)
        })()
    }, [])
            ...
            <a href={appleUrl}>
                <div
                    ...
                    <div
                        ...
                        <svg xmlns="http://www.w3.org/2000/svg" style={{"pointerEvents": "none", "overflow": "visible"}}
                             width="100%" height="100%">
                            <g>
                                <svg xmlns="http://www.w3.org/2000/svg" style={{"overflow": "visible"}} width="100%"
                                     height="50%" y="25%" viewBox="0 -11 111.046875 14" fill="#000">
                                    <defs>
                                        <style>
                                            {`
                                            @font-face {
                                    ...
                                    <text fontSize="12px" textLength="111.046875" fontFamily="applied-button-font-0"
                                          direction="ltr"> Sign in with Apple
                                    </text>
                                </svg>
                            </g>
                        </svg>
                    </div>
                    <div style={{"padding": "1px", "width": "100%", "height": "100%", "boxSizing": "border-box"}}>
                        <svg xmlns="http://www.w3.org/2000/svg" style={{"overflow": "visible"}} width="100%"
                             height="100%">
                            <rect width="100%" height="100%" ry="15%" fill="#fff" stroke="black" strokeWidth="1"
